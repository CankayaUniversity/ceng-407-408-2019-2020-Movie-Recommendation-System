...
def getrecommendations(request):
    movies = userLiked.objects.filter(username='adminadmin').values_list('liked_movie' , flat=True)
...
def movie_category(request):
    ...
    for i in range(0, 8):
        ...
        movies.append(movie_list[number])
...
def new_recommend(request):
    ...
    return JsonResponse(data={'recom_movie1': movie_list[0], 'recom_movie2': movie_list[1], 'recom_movie3': movie_list[2]
        , 'recom_movie4': movie_list[3], 'recom_movie5': movie_list[4], 'recom_movie6': movie_list[5], 'recom_movie7': movie_list[6],
                              'recom_movie8': movie_list[7]})